...
namespace Main
{
    public static class Base
    {
        ...
        public static IntPtr ReplayeInterfacePTR = IntPtr.Add(baseAddress, 0x1E90138);
        public static IntPtr pedListPTR = Base.GetPtr(Base.ReplayeInterfacePTR, new int[] { 0x18 });
        public static IntPtr WorldPTR = IntPtr.Add(baseAddress, 0x2366EC8);
        public static IntPtr AmmoPTR = IntPtr.Add(baseAddress, 0xE88EB9);
        public static IntPtr ClipPTR = IntPtr.Add(baseAddress, 0xE88E74);
        public static IntPtr BlipPTR = IntPtr.Add(baseAddress, 0x1F9E750);
        public static IntPtr PlayerPTR = IntPtr.Add(baseAddress, 0x1CE0AA0);
        public static IntPtr WaypointPTR_X = IntPtr.Add(baseAddress, 0x1FBCAE0);
        public static IntPtr WaypointPTR_Y = IntPtr.Add(baseAddress, 0x1FBCAE4);
